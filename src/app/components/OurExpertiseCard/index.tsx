        ...
        <div className="container mx-auto flex justify-center items-center m-4 rounded-2xl">
            <div className="flex flex-col lg:flex-row">
                <div className="w-full lg:w-1/2 p-10 bg-gray-100">
                    <Image src="/images/tech-review.webp" width={500} height={500} alt="dummy-image" className="rounded-t-lg lg:rounded-t-none lg:rounded-l-lg rounded-xl cursor-pointer" />
                </div>
